...
class MMF_IterativeM4C(nn.Module):
    ...
    def _build_encoder(self, config):
        ...
        self.encoder.load_state_dict(self.text_bert.state_dict(),strict=False)
    ...
    def _build_decoder(self, config):
        ...
        self.decoder.load_state_dict(self.text_bert.state_dict(),strict=False)
    ...
    def _forward_txt_encoding(self, items, fwd_results):
        ...
        text_bert_out = self.text_bert(
            txt_inds=fwd_results["txt_inds"], txt_mask=fwd_results["txt_mask"].unsqueeze(1).unsqueeze(1)
        )
